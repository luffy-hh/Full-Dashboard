...
export const { setModalShow ,setUserId,setCondition,setAmount,setWithDrawAmount} = modalSlice.actions;
...
export const selectDepositeAmount = (state) => state.modal.depositeToUser.amount;
export const selectWithDrawAmount = (state) => state.modal.depositeToUser.withdrawAmount;
